...
const AdminMenu = () => {
    ...
    const updateMessage = (error, message) => {
        setError(error)
        setMessage(message)
    }
    ...
    const handleMessage = response => {
        updateMessage(null, response.data.message)
    }
    
    const handleError = error => {
        console.log(error)
        updateMessage(error.response.data.error, null)
    }
            ...
            <div className="flex-1 flex-wrap justify-center sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div className="col-span-1 mb-4 w-full p-2">
                    <div className="mb-4">
                        ...
                        <input id="imageInput" type="file" onChange={handleFileUpload} className="cursor-pointer w-full"/>
                    </div>
