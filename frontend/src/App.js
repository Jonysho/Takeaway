...
const App = () => {
  ...
  return (
    <div className={`bg-gradient-to-t from-[#FFEFBA] to-[#ffffff] absolute top-0 left-0 h-full w-full ${isNavMBOpen ? 'overflow-hidden' : 'overflow-auto'}`}>
      <div className="flex flex-col">
        <div className='sticky top-[-3rem] sm:top-[-4.5rem] lg:top-[-8.6rem] z-[800]'>
          <Header location={location} isNavMBOpen={isNavMBOpen} setIsNavMBOpen={setIsNavMBOpen}/>
        </div>
